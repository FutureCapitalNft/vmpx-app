...
const Footer = ({ contractAddress: mainAddress, projectId = 'vmpx' }
  ...
  const isHomePage = router.asPath === '/'; // !networkId;
    ...
    <footer className={styles.footer}>
      <Grid container sx={{ alignItems: 'center', pt: 2 }} >
        ...
        <Grid item xs={12} md={6} >
          ...
          {isHomePage && <Typography variant="body2" sx={{ fontSize: 14, textAlign: 'left'  }}>
                  <StyledAnchor style={{ display: 'unset' }} href="/mint2">mint2</StyledAnchor>
          </Typography>}
        </Grid>
      </Grid>
    </footer>
